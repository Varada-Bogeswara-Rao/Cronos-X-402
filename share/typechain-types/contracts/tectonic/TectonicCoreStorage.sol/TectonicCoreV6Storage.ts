...
export interface TectonicCoreV6StorageInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TectonicCoreV6Storage extends BaseContract {
  connect(runner?: ContractRunner | null): TectonicCoreV6Storage;
  waitForDeployment(): Promise<this>;

  interface: TectonicCoreV6StorageInterface;
