...
export interface TectonicCoreV3StorageInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TectonicCoreV3Storage extends BaseContract {
  connect(runner?: ContractRunner | null): TectonicCoreV3Storage;
  waitForDeployment(): Promise<this>;

  interface: TectonicCoreV3StorageInterface;
