...
export interface TectonicCoreV5StorageInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TectonicCoreV5Storage extends BaseContract {
  connect(runner?: ContractRunner | null): TectonicCoreV5Storage;
  waitForDeployment(): Promise<this>;

  interface: TectonicCoreV5StorageInterface;
