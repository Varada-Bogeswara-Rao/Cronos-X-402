...
export interface TectonicCoreV4StorageInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TectonicCoreV4Storage extends BaseContract {
  connect(runner?: ContractRunner | null): TectonicCoreV4Storage;
  waitForDeployment(): Promise<this>;

  interface: TectonicCoreV4StorageInterface;
