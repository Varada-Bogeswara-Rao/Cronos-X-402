...
export interface TErc20DelegatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_acceptAdmin"
      | "_addReserves"
...
export interface TErc20Delegator extends BaseContract {
  connect(runner?: ContractRunner | null): TErc20Delegator;
  waitForDeployment(): Promise<this>;

  interface: TErc20DelegatorInterface;
