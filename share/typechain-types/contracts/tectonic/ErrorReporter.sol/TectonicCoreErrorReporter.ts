...
export interface TectonicCoreErrorReporterInterface extends Interface {
...
export interface TectonicCoreErrorReporter extends BaseContract {
  connect(runner?: ContractRunner | null): TectonicCoreErrorReporter;
  waitForDeployment(): Promise<this>;

  interface: TectonicCoreErrorReporterInterface;
