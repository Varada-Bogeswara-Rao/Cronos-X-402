...
export interface TErc20DelegateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_acceptAdmin"
      | "_addReserves"
  ...
  encodeFunctionData(
    functionFragment: "_setTectonicCore",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace NewTectonicCoreEvent {
  export type InputTuple = [
    oldTectonicCore: AddressLike,
    newTectonicCore: AddressLike
  ];
  export type OutputTuple = [oldTectonicCore: string, newTectonicCore: string];
  export interface OutputObject {
...
export interface TErc20Delegate extends BaseContract {
  connect(runner?: ContractRunner | null): TErc20Delegate;
  waitForDeployment(): Promise<this>;

  interface: TErc20DelegateInterface;
  ...
  _setTectonicCore: TypedContractMethod<
    [newTectonicCore: AddressLike],
    [bigint],
    "nonpayable"
  >;
  ...
  isTToken: TypedContractMethod<[], [boolean], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "_setTectonicCore"
  ): TypedContractMethod<
    [newTectonicCore: AddressLike],
    [bigint],
    "nonpayable"
  ...
  getEvent(
    ...
    NewTectonicCoreEvent.InputTuple,
    NewTectonicCoreEvent.OutputTuple,
    NewTectonicCoreEvent.OutputObject
  >;
  getEvent(
    key: "Redeem"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "NewTectonicCore(address,address)": TypedContractEvent<
      NewTectonicCoreEvent.InputTuple,
      NewTectonicCoreEvent.OutputTuple,
      NewTectonicCoreEvent.OutputObject
    >;
    NewTectonicCore: TypedContractEvent<
      NewTectonicCoreEvent.InputTuple,
      NewTectonicCoreEvent.OutputTuple,
      NewTectonicCoreEvent.OutputObject
    >;
