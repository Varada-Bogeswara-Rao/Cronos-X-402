...
export interface TErc20InterfaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_addReserves"
      | "borrow"
...
export interface TErc20Interface extends BaseContract {
  connect(runner?: ContractRunner | null): TErc20Interface;
  waitForDeployment(): Promise<this>;

  interface: TErc20InterfaceInterface;
