...
export interface TTokenInterfaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_acceptAdmin"
      | "_reduceReserves"
...
export interface TTokenInterface extends BaseContract {
  connect(runner?: ContractRunner | null): TTokenInterface;
  waitForDeployment(): Promise<this>;

  interface: TTokenInterfaceInterface;
